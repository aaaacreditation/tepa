...
export const booking = {
  ...
  orgTypes: [
    ...
    "Other organization",
    "I'm an individual professional, not an organization",
  ],
  individual: "I'm an individual professional, not an organization",
  individualNote:
    "AAA accredits organizations that deliver training, not individuals. If you are looking for an accredited course or trainer, search the providers in our directory.",
